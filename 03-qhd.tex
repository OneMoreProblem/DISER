...
\begin{figure}[!ht]
    \centering
        ...
        \end{tikzpicture}
        \caption{Re=1000, $\alpha = 30^\circ$, зависимость $U_x$ от $y$, горизонтальная компонента скорости вдоль линии AB.}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \begin{tikzpicture}[scale=4.5, every node/.style={scale=1}]
            \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=1.055\textwidth]{pics/StreamlinesAtPressureCrop.png}};
            \draw (0,0,0)--(1,0,0)--(1.7071,0.7071,0.0)--(0.7071,0.7071,0.0)--cycle;
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{tikzpicture}[scale=4.5, every node/.style={scale=1}]
            \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=1.15\textwidth]{pics/StreamlinesAtPressureCropTikz30.png}};
